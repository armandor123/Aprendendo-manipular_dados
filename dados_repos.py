...
class DadosRepositorios:
    ...
    def __init__(self, owner):
        ...
        self.access_token='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'
...
ling_mais_usada_amzn.to_csv('dados/linguagens_amzn.csv')
ling_mais_usada_amzn.to_csv('dados/linguagens_netflix.csv')
ling_mais_usada_amzn.to_csv('dados/linguagens_spotify.csv')
